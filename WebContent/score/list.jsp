				...
				<article id="main_container">
					<form method="post" name="listForm">
						...
						<div class="row">
							<div class="row_title">
								<h3>
									<strong class="strong">성적</strong> 조회하기
								</h3>
							</div>
							<div class="row_buttons">
								<input class="delete_button" type="button" value="삭제"
									class="btn" /> <input class="enroll_button" type="button"
									value="  등록하기  " class="btn"
						...
						<div class="row">
							<table id="card_history">
								<thead>
									<tr>
										<td calss="col_check"><input type="checkbox"
											name="chkAll" value="all" /></td>
								...
								<tbody>
									...
									<tr>
										...
										<td><%=dto.getAve()%></td>
										<td><%=dto.getRank()%></td>
										<td><input type="button" value="수정" class="btn" /> <input
											type="button" value="삭제" class="btn"
											onclick="deleteScore('<%=dto.getHak()%>')" /></td>
									</tr>
									<%
										}
									%>
