		...
		<main id="content">
			<div id="main">
				<article id="main_container">
					...
					<div class="row">
						<form action="update_ok.jsp" name="score"
								...
								<div class="join_form">
									<div class="component_wrap">
										...
										<div class="join_item">
											<strong>학번</strong> <input type="text" name="hak"
												value="<%=dto.getHak()%>" readonly="readonly"/>
										</div>
										<div class="join_item">
									...
									<div class="join_item_title submit">
										<button type="submit" name="btn"
											class="row_button navy_button">등록하기</button>
										<button type="reset" name="btn"
											class="row_button white_button">다시입력</button>
										<button type="button" name="btn"
											class="row_button white_button"
											onclick="javascript:location.href='list.jsp'">등록취소</button>
									</div>
								</div>
							</div>
						</form>
