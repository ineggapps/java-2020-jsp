				...
				<table>
					<tr class="list-row-2">
						...
						<td style="padding-left: 5px;"><input type="text"
							name="userId" id="userId" maxlength="10" class="boxTF"> <span
							id="userIdState" style='display: none;'></span></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">패스워드</td>
						<td style="padding-left: 5px;"><input type="password"
							name="userPwd" class="boxTF" maxlength="10"></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">패스워드 확인</td>
						<td style="padding-left: 5px;"><input type="password"
							name="userPwd1" class="boxTF" maxlength="10"></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">이&nbsp;&nbsp;&nbsp;&nbsp;름</td>
						<td style="padding-left: 5px;"><input type="text"
							name="userName" maxlength="20" class="boxTF"></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">생년월일</td>
						<td style="padding-left: 5px;"><input type="text"
							name="birth" maxlength="20" class="boxTF"></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">이 메 일</td>
						<td style="padding-left: 5px;"><select name="selectEmail"
							class="selectField" onchange="changeEmail();">
						...
						</select> <input type="text" name="email1" maxlength="30" class="boxTF">
							@ <input type="text" name="email2" maxlength="30" class="boxTF"
							readonly="readonly"></td>
					</tr>

					<tr class="list-row-1">
						<td width="100" align="center" bgcolor="#E6E6E6">전화번호</td>
						<td style="padding-left: 5px;"><select name="tel1"
							class="selectField">
								<option value="">선 택</option>
						...
						</select> <input type="text" name="tel2" maxlength="4" class="boxTF">
					...
					<tr class="list-row-1">
						...
						<td style="padding-left: 5px;"><input type="text" id="zip" name="zip"
							size="25" maxlength="7" class="boxTF" readonly="readonly">
							<button type="button" class="btn" onclick="daumPostcode();">우편번호검색</button>
						</td>
					</tr>

					<tr class="list-row-1" style="height: 70px;">
						<td width="100" align="center" bgcolor="#E6E6E6" valign="top"
							style="padding-top: 10px;">주&nbsp;&nbsp;&nbsp;&nbsp;소</td>
						<td style="padding-left: 5px;"><label
							style="display: block; margin-top: 5px;"> <input
								type="text" id="addr1" name="addr1" maxlength="50" class="boxTF"
								readonly="readonly" style="width: 96%;">
						</label> <label
							style="display: block; margin-top: 5px; margin-bottom: 5px;">
								<input type="text" id="addr2" name="addr2" maxlength="50" class="boxTF"
								style="width: 96%;">
						</label></td>
					</tr>
					...
					<tr class="list-row-1">
						...
						<td style="padding-left: 5px;"><input type="text" name="job"
							maxlength="7" class="boxTF"></td>
					</tr>
					...
					<tr height="40">
						<td align="center" colspan="2"><span style="color: blue;"></span>
						</td>
					</tr>
				</table>
			</form>
