...
public class MyCustomUtil {
	...
	public int[] paging(int current_page, int total_page, String list_url) {
		return paging(10, current_page, total_page, list_url);
	}

	public int[] paging(int rows, int current_page, int total_page, String list_url) {

		int numPerBlock = rows;
		int center = (numPerBlock/2);
